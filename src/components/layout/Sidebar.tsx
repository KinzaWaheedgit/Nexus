...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, Video, Folder // Yahan Video aur Folder add kiya
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    // Naye Links yahan add kiye
    { to: '/video-call', icon: <Video size={20} />, text: 'Video Call' },
    { to: '/document-chamber', icon: <Folder size={20} />, text: 'Document Chamber' },
  ];
